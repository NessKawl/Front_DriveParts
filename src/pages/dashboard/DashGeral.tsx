...
export default function DashGeral() {
    ...
    useEffect(() => {
        ...
        reservas.forEach((r) => {
            if (!r.ven_data_criacao) return;
            const dataR = new Date(r.ven_data_criacao);
            let key = "";
            if (filtro === "Dia" || filtro === "Semanal") {
        ...
        const dados = datas.map((d) => ({ name: d, ...mapa[d] }));
                ...
                <div className="flex flex-row gap-4 w-full h-full">
                    <div className="flex flex-col w-full gap-2">
                        <div className="flex flex-row gap-2 items-center mb-2">
                            <label className="text-white">Filtrar Reservas:</label>
                            <select
                                value={filtro}
